  ...
  function startDuoCampaignEncounter(options={}){
    ...
    if(bossRush)addLog(`Boss Rush ${roundNumber}/10: ${encounter.title}. Verbleibende HP und gewählte Rush-Fähigkeiten werden in den nächsten Kampf übernommen.`);
