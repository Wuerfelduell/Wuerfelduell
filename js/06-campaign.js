  ...
  function renderDuoCampaign(){
    ...
    duoCampaignStartBtn.disabled=!baseUnlocked||!worldUnlocked||!encounter||!duoEncounterAvailable(p1,p2,encounter)||!duoAbility1Select.value||!duoAbility2Select.value;window.WDMastery?.refreshAll?.();window.WDBossRush?.refreshButton?.();
  }
  ...
  function renderTrioCampaign(){
    ...
    trioCampaignStartBtn.disabled=!validTeam||!worldUnlocked||!encounter||!trioEncounterAvailable(p1,p2,p3,encounter)||!primaryOk;trioCampaignStartBtn.title=!primaryOk?"Für diesen Encounter gilt das angezeigte Pflicht-Loadout.":"";window.WDMastery?.refreshAll?.();window.WDBossRush?.refreshButton?.();
  }
