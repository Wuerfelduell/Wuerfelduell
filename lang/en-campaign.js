...
(() => { const pack=(window.WD_LANG_PACKS||{}).en; if(pack)Object.assign(pack.exact, {
  ...
  "Der Partner erhält deine gewählte Belohnung eine Stufe später ebenfalls, einmal pro Stapel.": "Your partner also receives your chosen reward one stage later, once per stack.",
  "Kundschafter": "Scout",
