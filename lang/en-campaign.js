...
(() => { const pack=(window.WD_LANG_PACKS||{}).en; if(pack)Object.assign(pack.exact, {
  ...
  "Die nächsten zwei Stufen erhält der Partner je eine deiner Belohnungen eine Stufe später ebenfalls. Ein erneuter Fund verlängert um zwei Stufen.": "For the next two stages your partner also receives one of your rewards a stage later. Finding it again extends this by two stages.",
  "Kundschafter": "Scout",
...
(() => {
  ...
  Object.assign(pack.exact,{
    ...
    "Die nächsten zwei Stufen erhält je ein Mitspieler eine deiner Belohnungen eine Stufe später ebenfalls. Ein erneuter Fund verlängert um zwei Stufen.":"For the next two stages one teammate also receives one of your rewards a stage later. Finding it again extends this by two stages.",
