...
// Duo Boss Rush: Pfade, Seltenheiten und Perks.
(() => { const pack=(window.WD_LANG_PACKS||{}).en; if(pack)Object.assign(pack.exact, {
  "Henkersblick": "Executioner’s Eye",
  "Angriffe auf Gegner unter 30 % ihrer maximalen HP verursachen +4 Schaden pro Stapel.": "Attacks against enemies below 30% of their maximum HP deal +4 damage per stack.",
  "Vergeltung": "Retribution",
  "Jeder gefallene eigene Held erhöht den Angriffsschaden um 3 pro Stapel.": "Each fallen allied hero increases attack damage by 3 per stack.",
  "Aufopferung": "Sacrifice",
  "Unter 50 % eigener HP: +2 Angriffsschaden, unter 25 %: +4 pro Stapel.": "Below 50% of your HP: +2 attack damage; below 25%: +4 per stack.",
  "Schwung": "Impetus",
  "Jeder bereits besiegte Boss erhöht den Angriffsschaden um 1 pro Stapel.": "Each defeated boss increases attack damage by 1 per stack.",
  "Präzisionsdrill": "Precision Drill",
  "Jeder dritte erfolgreiche eigene Hauptangriff im Run verursacht +6 Schaden pro Stapel.": "Every third successful main attack of your own during the run deals +6 damage per stack.",
  "Glücksspiel": "Gamble",
  "Dauerhaft +5 Angriffsschaden und -5 maximale HP pro Stapel; mindestens 10 maximale HP bleiben.": "Permanently gain +5 attack damage and lose 5 maximum HP per stack; maximum HP cannot fall below 10.",
  ...
  "Blutpakt": "Blood Pact",
  "Heilt sofort 25 HP; nach jedem weiteren Boss kostet jeder Stapel 3 HP, ohne zu töten.": "Immediately heals 25 HP; after each subsequent boss, each stack costs 3 HP without killing you.",
  "Schuppenpanzer": "Scale Armour",
  "Eingehender Gegnerangriffsschaden sinkt um 1 pro Stapel, mindestens auf 0.": "Incoming enemy attack damage is reduced by 1 per stack, to a minimum of 0.",
  "Bollwerk": "Bulwark",
  "Der erste Gegnerangriff auf diesen Helden je Boss verursacht 4 Schaden weniger pro Stapel.": "The first enemy attack against this hero in each boss fight deals 4 less damage per stack.",
  "Ausweichinstinkt": "Evasive Instinct",
  "Unter 30 % eigener HP verursachen Gegnerangriffe 2 Schaden weniger pro Stapel.": "Below 30% of your HP, enemy attacks deal 2 less damage per stack.",
  "Neuausrichtung": "Realignment",
  "Wähle einen belegten Fähigkeitsslot; seine Fähigkeit wird zufällig gegen eine noch nicht besessene getauscht.": "Choose an occupied ability slot; its ability is randomly replaced with one you do not already own.",
  "Neuwurf": "Reroll",
  "Gewährt pro Stapel einen Neuwurf einer Belohnungsauswahl im Run.": "Grants one reward-selection reroll during the run per stack.",
  "Vorratspaket": "Supply Package",
  "Die nächste eigene Belohnungsauswahl enthält vier statt drei Perks; einmal pro Stapel.": "Your next reward selection contains four perks instead of three; once per stack.",
  "Zweitfund": "Second Find",
  "Die nächsten drei Stufen erhält der Partner je eine deiner Belohnungen eine Stufe später ebenfalls. Ein erneuter Fund verlängert um drei Stufen.": "For the next three stages your partner also receives one of your rewards a stage later. Finding it again extends this by three stages.",
  "Kundschafter": "Scout",
  "Zeigt bei der Pfadwahl die Fähigkeiten aller angebotenen Gegner.": "Shows the abilities of all offered enemies when choosing a path.",
  "Trophäengier": "Trophy Greed",
  "Erhöht die eigenen Boss-XP im restlichen Run um 50 % pro Stapel.": "Increases your own boss XP for the remainder of the run by 50% per stack.",
  "Wechselspiel": "Relay",
  "Solange beide leben: Greift nach dem Partner an und verursacht +2 Schaden pro Stapel.": "While both heroes live, attacking after your partner deals +2 damage per stack.",
  "Proviantteilung": "Shared Provisions",
  "Vor jedem Boss gibt der gesündere Held bis zu 3 HP pro Stapel an den schwächeren ab, höchstens bis zum Gleichstand.": "Before each boss, the healthier hero gives up to 3 HP per stack to the weaker hero, at most until their HP are equal.",
  "Kartograph": "Cartographer",
  "Gewährt pro Stapel einen Austausch eines Pfadangebots gegen einen ungesehenen Encounter derselben Stufe.": "Each stack allows you to replace one path offer with an unseen encounter from the same stage.",
  "Auslese": "Spoils",
  "Nach einem Boss ohne erlittenen Schaden erhält dieser Held je Stapel zusätzlich einen zufälligen gewöhnlichen Perk.": "After a boss without taking damage, this hero additionally receives one random common perk per stack.",
  "Plünderer": "Plunderer",
  "Jeder eigene Gegner-Kill bringt bei einem gewonnenen Boss 10 zusätzliche eigene Boss-XP pro Stapel.": "Each enemy you kill grants 10 additional boss XP per stack when the boss fight is won.",
  "Basis-Boss-XP": "Base boss XP",
  "leicht": "easy",
  "normal": "normal",
  "schwer": "hard",
  "gewöhnlich": "common",
  ...
  "episch": "epic",
  "Stapel": "Stacks",
  "3 gewöhnliche Belohnungen": "3 common rewards",
  "3 Belohnungen · mindestens eine seltene": "3 rewards · at least one rare",
  "3 Belohnungen · mindestens eine epische + Fähigkeitsangebot": "3 rewards · at least one epic + an ability offer",
  "Wähle eine Belohnung": "Choose a reward",
  "Fähigkeit zum Tauschen wählen": "Choose an ability to replace",
  "Diesen belegten Slot tauschen": "Replace this occupied slot",
  "Setzt die 3. Fähigkeit für die nächsten Stufen.": "Sets the third ability for the next stages.",
  "Belohnungen neu würfeln": "Reroll rewards",
  "Nächsten Gegner wählen": "Choose your next opponent",
  "Schwerer Pfad, bessere Beute": "Harder path, better loot",
  "Pfad neu ziehen": "Reroll path",
  "Offener Boss Rush": "Unfinished Boss Rush",
  "Fortsetzen": "Continue",
  "Neu starten": "Start over",
  "Am gespeicherten Abschnitt weiterspielen": "Continue from the saved section",
  "Den offenen Run durch einen neuen ersetzen": "Replace the unfinished run with a new one",
  "Boss besiegt": "Boss defeated",
  "Fähigkeit": "Ability",
  "Stufe": "Stage"
}); })();
...
(() => {
  ...
  Object.assign(pack.exact,{
    ...
    "pro Würfeltreffer":"per die hit",
    "Run-Belohnung":"Run reward",
    "Weitergeben":"Pass on",
    "Ablehnen":"Decline",
    "Diese Belohnung geht stattdessen an":"This reward goes to",
    "Diese Belohnung verfällt ersatzlos.":"This reward is forfeited.",
    "Die nächsten drei Stufen erhält je ein Mitspieler eine deiner Belohnungen eine Stufe später ebenfalls. Ein erneuter Fund verlängert um drei Stufen.":"For the next three stages one teammate also receives one of your rewards a stage later. Finding it again extends this by three stages.",
